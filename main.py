...
while n <= 30:
    ...
    L3 = geo.get_k(Lu, Phi, K)
    y1.append(utils.get_area(L1))
    y2.append(utils.get_area(L2))
    y3.append(utils.get_area(L3))
    yy1.append(utils.cal_e(L1, Phi))
    yy2.append(utils.cal_e(L2, Phi))
    yy3.append(utils.cal_e(L3, Phi))
